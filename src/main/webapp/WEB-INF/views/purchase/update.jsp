    ...
    <div class="card">
        <div class="card-body">
                            ...
                            <select class="form-control" type="text" name="materialProductNo" id="materialProductNo" onchange="updateMaterialPrice(); calculateTotal()">
                                <c:forEach items="${material}" var="f">
                                    <c:if test="${f.materialProductCategory eq '원료'}">
                                        <option value="${f.materialProductNo}" data-price="${f.materialProductPrice}" ${f.materialProductNo == kvo.materialProductNo ? 'selected' : ''}>${f.codeName}</option>
                                    </c:if>
                                </c:forEach>
                            </select>
                        </td>
            ...
            <div style="float: right;">
                ...
                <button class="btn btn-info" type="submit" id="update-confirm-btn">수정하기</button>
            </div>
            </form>
        </div>
    </div>
